...
import { useCreateUserAccount, useSignInAccount} from "@/lib/react-query/queriesAnsMutations"
...
<p className="text-light-3 small-medium md:base-regular mt-2">To use Gloomygram, Please enter your details</p>
